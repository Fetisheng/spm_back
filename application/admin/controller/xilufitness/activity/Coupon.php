...
class Coupon extends Backend
{
    ...
    /**
     * Coupon模型对象
     * @var \app\admin\model\xilufitness\activity\Coupon
     */
     ...
     * 快捷查询
     */
    protected $searchFields = 'brand.brand_name,coupon.title';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\xilufitness\activity\Coupon;
