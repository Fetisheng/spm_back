...
namespace app\admin\controller\xilufitness\banner;
...
class Index extends Backend
{
    ...
    /**
     * Index模型对象
     * @var \app\admin\model\xilufitness\banner\Index
     */
     ...
     * 快捷查询
     */
    protected $searchFields = 'brand.brand_name,index.title';

    public function _initialize()
    {
        parent::_initialize();
        $this->model = new \app\admin\model\xilufitness\banner\Index;
        $this->view->assign("statusList", $this->model->getStatusList());
        $this->view->assign('positionList',$this->model->getPositionList());
        $this->assignconfig('positionList',$this->model->getPositionList());
