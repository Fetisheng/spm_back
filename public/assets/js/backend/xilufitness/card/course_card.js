define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xilufitness/card/course_card/index',
                    add_url: 'xilufitness/card/course_card/add',
                    edit_url: 'xilufitness/card/course_card/edit',
                    del_url: 'xilufitness/card/course_card/del',
                    multi_url: 'xilufitness/card/course_card/multi',
                    table: 'category',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'timescardquota', title: __('课程次卡额度（次）') },
