define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xilufitness/card/term_card/index',
                    add_url: 'xilufitness/card/term_card/add',
                    edit_url: 'xilufitness/card/term_card/edit',
                    del_url: 'xilufitness/card/term_card/del',
                    multi_url: 'xilufitness/card/term_card/multi',
                    table: 'category',
                }
            });
