define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xilufitness/order/card/index' + location.search,
                    edit_url: 'xilufitness/order/card/edit',
                    del_url: 'xilufitness/order/card/del',
                    multi_url: 'xilufitness/order/card/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'category.cardname', title: __('会员卡名称'), sortable:true},
                        {field: 'pay_amount', title: __('Pay_amount'), operate:'BETWEEN', sortable:true},
                        {field: 'category.cardtypename', title: __('会员卡类型'), sortable:true},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'xilufitness/order/card/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'xilufitness/order/card/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'xilufitness/order/card/destroy',
                                    refresh: true
                                }
                            ],
