define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xilufitness/order/card_package/index' + location.search,
                    edit_url: 'xilufitness/order/card_package/edit',
                    del_url: 'xilufitness/order/card_package/del',
                    multi_url: 'xilufitness/order/card_package/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'package.package_name', title: __('套餐名称'), sortable:true},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'xilufitness/order/card_package/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'xilufitness/order/card_package/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'xilufitness/order/card_package/destroy',
                                    refresh: true
                                }
                            ],
