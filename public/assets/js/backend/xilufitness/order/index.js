define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xilufitness/order/index/index' + location.search,
                    edit_url: 'xilufitness/order/index/edit',
                    del_url: 'xilufitness/order/index/del',
                    multi_url: 'xilufitness/order/index/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'recharge.recharge_amount', title: __('Data_id_0'), sortable:true},
                        {field: 'pay_amount', title: __('Pay_amount'), operate:'BETWEEN', sortable:true},
                        {field: 'recharge.account_amount', title: __('Total_amount'), operate:'BETWEEN', sortable:true},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'xilufitness/order/index/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'xilufitness/order/index/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'xilufitness/order/index/destroy',
                                    refresh: true
                                }
                            ],
